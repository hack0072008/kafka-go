...
`kafka-go` is currently compatible with golang version from 1.15+. To use with older versions of golang use release [v0.2.5](https://github.com/hack0072008/kafka-go/releases/tag/v0.2.5).

## Connection [![GoDoc](https://godoc.org/github.com/hack0072008/kafka-go?status.svg)](https://godoc.org/github.com/hack0072008/kafka-go#Conn)
...
## Reader [![GoDoc](https://godoc.org/github.com/hack0072008/kafka-go?status.svg)](https://godoc.org/github.com/hack0072008/kafka-go#Reader)
...
## Writer [![GoDoc](https://godoc.org/github.com/hack0072008/kafka-go?status.svg)](https://godoc.org/github.com/hack0072008/kafka-go#Writer)
...
#### [Plain](https://godoc.org/github.com/hack0072008/kafka-go/sasl/plain#Mechanism)
```go
...
#### [SCRAM](https://godoc.org/github.com/hack0072008/kafka-go/sasl/scram#Mechanism)
```go
