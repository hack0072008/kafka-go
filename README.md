# kafka-go [![CircleCI](https://circleci.com/gh/segmentio/kafka-go.svg?style=shield)](https://circleci.com/gh/segmentio/kafka-go) [![Go Report Card](https://goreportcard.com/badge/gitlab-ce.alauda.cn/yhzhang/kafka-go)](https://goreportcard.com/report/gitlab-ce.alauda.cn/yhzhang/kafka-go) [![GoDoc](https://godoc.org/gitlab-ce.alauda.cn/yhzhang/kafka-go?status.svg)](https://godoc.org/gitlab-ce.alauda.cn/yhzhang/kafka-go)
...
`kafka-go` is currently compatible with golang version from 1.15+. To use with older versions of golang use release [v0.2.5](https://gitlab-ce.alauda.cn/yhzhang/kafka-go/releases/tag/v0.2.5).

## Connection [![GoDoc](https://godoc.org/gitlab-ce.alauda.cn/yhzhang/kafka-go?status.svg)](https://godoc.org/gitlab-ce.alauda.cn/yhzhang/kafka-go#Conn)
...
## Reader [![GoDoc](https://godoc.org/gitlab-ce.alauda.cn/yhzhang/kafka-go?status.svg)](https://godoc.org/gitlab-ce.alauda.cn/yhzhang/kafka-go#Reader)
...
## Writer [![GoDoc](https://godoc.org/gitlab-ce.alauda.cn/yhzhang/kafka-go?status.svg)](https://godoc.org/gitlab-ce.alauda.cn/yhzhang/kafka-go#Writer)
...
#### [Plain](https://godoc.org/gitlab-ce.alauda.cn/yhzhang/kafka-go/sasl/plain#Mechanism)
```go
...
#### [SCRAM](https://godoc.org/gitlab-ce.alauda.cn/yhzhang/kafka-go/sasl/scram#Mechanism)
```go
